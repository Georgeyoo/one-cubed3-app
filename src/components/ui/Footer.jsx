        ...
        <div>
            <footer className="flex flex-col gap-6 px-5 py-10 lg:py-16 xl:py-20 text-center container mx-auto">
                <div className="flex flex-wrap justify-center gap-4 lg:gap-6 xl:gap-8">
                    <a
                        href="#"
                        className="text-text-secondary hover:text-[#E7E247] transition-colors"
                        aria-label="Twitter"
                    >
                        <div className="text-text-secondary hover:text-[#E7E247] transition-colors lg:scale-125 xl:scale-150" data-icon="TwitterLogo" data-size="24px" data-weight="regular">
                    ...
                    <a
                        ...
                        aria-label="Discord"
                    >
                        <div className="text-text-secondary hover:text-[#E7E247] transition-colors lg:scale-125 xl:scale-150" data-icon="DiscordLogo" data-size="24px" data-weight="regular">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                ...
                <p className="text-white text-base lg:text-lg xl:text-xl font-normal leading-normal">
